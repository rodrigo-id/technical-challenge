...
class UrlBasicOperationControllerTest {

  UrlBasicOperationController urlBasicOperationController;
  ...
  @BeforeEach
  void setUp() {
    urlBasicOperationController = new UrlBasicOperationController(urlShortUseCase, urlDeleteUseCase, urlLogUseCase);
  ...
  void givenUrlController_whenProvideALongUrl_thenReturnTheUrlShorted() {
    ...
    ResponseEntity<UrlShortResponse> urlResponseEntity = urlBasicOperationController
  ...
  void givenUrlController_whenDeleteAShortUrl_thenDeleteWithAStatusCode200() {
    ResponseEntity<Void> response = urlBasicOperationController.deleteShortUrl(urlRequest);
